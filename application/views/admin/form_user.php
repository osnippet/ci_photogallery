...
<table width="100%" border="0" >
  ...
  <tr>
    ...
    <td><input type="text" name="first_name"  class="txt1" value="<?php echo set_value('first_name', isset($user['first_name']) ? $user['first_name'] : '' ); ?>" /></td>
  </tr>
  <tr>
    <td valign="top" >Lastname</td>
    <td><input type="text" name="last_name"  class="txt1" value="<?php echo set_value('last_name', isset($user['last_name']) ? $user['last_name'] : '' ); ?>"></td>
  </tr>
